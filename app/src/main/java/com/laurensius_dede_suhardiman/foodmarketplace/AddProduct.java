...
//    String image;
    ...
    private void showPictureDialog(){
        AlertDialog.Builder pictureDialog = new AlertDialog.Builder(AddProduct.this);
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    saveImage(bitmap);
                    Toast.makeText(AddProduct.this, "Simpan gambar berhasil", Toast.LENGTH_SHORT).show();
                    ivImage.setImageBitmap(bitmap);
                    is_taked = true;
                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(AddProduct.this, "Simpan gambar gagal", Toast.LENGTH_SHORT).show();
                    is_taked = false;
                }
            }
    ...
    void validateUploadProduk(){
        if(is_taked == true &&
            ...
            Toast.makeText(AddProduct.this,"Semua kolom harus diisi!",Toast.LENGTH_LONG).show();
        }
    }
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            if(response.getString("severity").equals("success")){
                                ...
                                Toast.makeText(AddProduct.this,response.getString("message"),Toast.LENGTH_LONG).show();
                                new AlertDialog.Builder(AddProduct.this)
                                        .setTitle("Informasi")
                                        .setMessage(response.getString("message"))
