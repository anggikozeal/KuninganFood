...
public class ResultSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String search = intent.getStringExtra("val");
        Toast.makeText(getApplicationContext(),search,Toast.LENGTH_LONG).show();

        etCari.setText(search);

        rvProduct.addOnItemTouchListener(new CustomListener(ResultSearch.this, new CustomListener.OnItemClickListener() {
            @Override
            public void onItemClick(View childVew, int childAdapterPosition) {
                ...
                Intent intent = new Intent(ResultSearch.this,DetailProduct.class);
        ...
        rvProduct.setLayoutManager(new GridLayoutManager(ResultSearch.this,2));
        productAdapter = new ProductAdapter(listProduct,ResultSearch.this);
    ...
    public void requestProductSearch(String val){
        Random random = new Random();
        int rnd = random.nextInt(999999 - 99) + 99;
        String product_search = getResources().getString(R.string.tag_request_product_search);
        String url = getResources().getString(R.string.api)
                .concat(getResources().getString(R.string.endpoint_product_search))
                .concat(val) //limit
                .concat(getResources().getString(R.string.slash))
                .concat(String.valueOf(rnd))
                .concat(getResources().getString(R.string.slash));
        final ProgressDialog pDialog = new ProgressDialog(ResultSearch.this);
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.dismiss();
                        Toast.makeText(ResultSearch.this,"Response Error",Toast.LENGTH_LONG).show();
