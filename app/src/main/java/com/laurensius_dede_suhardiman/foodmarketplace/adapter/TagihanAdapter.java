...
public class TagihanAdapter extends RecyclerView.Adapter<TagihanAdapter.HolderTransaction> {
    List<Transaction> listTransaction;
    Context ctx;

    public TagihanAdapter(List<Transaction> listTransaction, Context ctx){
    ...
    public HolderTransaction onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_tagihan,viewGroup,false);
    ...
    public void onBindViewHolder(HolderTransaction holderTransaction,final int i){
        ...
        TransactionTagihanAdapter transactionTagihanAdapter = null;
        ...
        transactionTagihanAdapter = new TransactionTagihanAdapter(transactionDetailList,ctx);
        transactionTagihanAdapter.notifyDataSetChanged();
        holderTransaction.rvProductKeranjang.setAdapter(transactionTagihanAdapter);
    ...
    public static class HolderTransaction extends  RecyclerView.ViewHolder{
        ...
        HolderTransaction(View itemView){
            ...
            btnKonfirmasiPembayaran = (Button)itemView.findViewById(R.id.btn_confirm);
        }
    }
}